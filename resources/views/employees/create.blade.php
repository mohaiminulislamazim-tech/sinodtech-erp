                        ...
                        <div class="p-6">
                            <form action="{{ route("employees.store") }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="address" id="address" rows="5" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old("address") }}</textarea>
                                    @error("address")
                                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="salary" id="salary" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old("salary") }}">
                                    @error("salary")
                                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                                    @enderror
                                </div>
